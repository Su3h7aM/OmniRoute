...
export const APIKEY_PROVIDERS = {
	...
	glmt: {
		...
		website: "https://open.bigmodel.cn",
		apiHint:
			"Preset GLM profile with higher token budget, thinking enabled, and longer timeout.",
	},
	"bailian-coding-plan": {
	...
	scaleway: {
		...
		hasFree: true,
		freeNote:
			"1M free tokens for new accounts — EU/GDPR compliant (Paris), Qwen3 235B & Llama 70B",
	},
	deepinfra: {
		id: "deepinfra",
		alias: "deepinfra",
...
export const SEARCH_PROVIDERS = {
	...
	"searxng-search": {
		...
		authHint:
			"Set your SearXNG base URL. API key is optional for public/self-hosted instances.",
	},
};
