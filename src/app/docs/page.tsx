					...
					<ol className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
						...
						<li className="rounded-lg border border-border p-3 bg-bg">
							...
							<p className="text-text-muted mt-1">
								...
								<code className="px-1 rounded bg-bg-subtle">
									https://&lt;host&gt;/v1
								</code>
				...
				>
					...
					<div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
						{useCases.map((item) => (
							<article
								key={item.titleKey}
								className="rounded-lg border border-border p-4 bg-bg"
							>
						...
						<article className="rounded-lg border border-border p-4 bg-bg">
							...
							<ul className="mt-2 text-text-muted space-y-1">
								<li>
									...
									<code className="px-1 rounded bg-bg-subtle">cu/</code>{" "}
								...
								{providerPrefixRows.map((p) => (
									<tr key={p.id} className="border-b border-border/60">
										<td className="py-2 pr-4 font-mono">
											<code className="px-1.5 py-0.5 rounded bg-bg">
												{p.alias}/
											</code>
										</td>
