			...
			<div className="flex items-center gap-3 mb-4">
				...
				<h3 className="text-lg font-semibold">
					{translateOrFallback(
						t,
						"comboDefaultsTitle",
						"Default Routing & Combo Settings"
					)}
				</h3>
			...
			<div className="flex flex-col gap-4">
						...
						{strategyOptions.map((s) => (
							<button
								...
								onClick={async () => {
									...
									try {
										await syncGlobalRoutingSettings({
											fallbackStrategy: s.value,
										});
									} catch (error) {
						...
						<Input
							...
							onChange={async (e) => {
								...
								try {
									...
									console.error(
										"Failed to sync sticky round robin limit:",
										error
									);
									showStatus("error", t("errorOccurred"));
								}
					...
					<div className="flex items-center justify-between">
						...
						<Toggle
							...
							onChange={() =>
								setComboDefaults((prev) => ({
									...prev,
									trackMetrics: !prev.trackMetrics,
								}))
							}
						/>
					</div>
				...
				<div className="pt-3 border-t border-border/50">
					...
					{Object.entries(providerOverrides).map(([provider, config]: [string, any]) => (
						...
						>
							<span className="text-xs font-mono font-medium min-w-[80px]">
								{provider}
							</span>
							<Input
								type="number"
