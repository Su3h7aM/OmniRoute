								...
								<div className="space-y-2">
									{Object.entries(metrics.byProvider).map(([provider, stats]) => {
										const providerCacheRate =
											stats.inputTokens > 0
												? (stats.cachedTokens / stats.inputTokens) * 100
												: 0;
										return (
											<div
												key={provider}
											...
											>
												<div className="flex items-center gap-3">
													<span className="text-text-main capitalize w-24">
														{provider}
													</span>
												...
												<div className="flex items-center gap-4 font-mono">
													...
													<span
														...
														title={t("cacheCreationWrite")}
													>
														{t("writeShort")}:{" "}
														{stats.cacheCreationTokens.toLocaleString()}
													</span>
