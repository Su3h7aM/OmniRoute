						...
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-xs text-text-muted mt-0.5">
									{catalog.endpoints.length} endpoints across {allTags.length}{" "}
									categories
								</p>
							</div>
						</div>
				...
				<>
					...
					<Card className="p-4">
						...
						<p className="text-[11px] text-text-muted mb-2">
							...
							header signed with HMAC-SHA256 using the webhook secret. Verify the
							signature to ensure the payload is authentic.
						</p>
						<div className="rounded-lg bg-black/5 dark:bg-black/30 p-3">
