...
export default function APIPageClient({ machineId }) {
	...
	const [cloudflaredStatus, setCloudflaredStatus] = useState<CloudflaredTunnelStatus | null>(
		null
	);
	...
	const postCloudAction = async (action, timeoutMs = CLOUD_ACTION_TIMEOUT_MS) => {
		...
		try {
			...
			return {
				ok: false,
				status: 500,
				data: { error: error.message || t("cloudRequestFailed") },
			};
		} finally {
				...
				if (data.verified) {
					...
					setCloudStatus({
						...
						message: data.verifyError
							? t("connectedVerificationPendingWithError", {
									error: data.verifyError,
								})
	...
	const cloudflaredPhaseMeta: Record<
				...
				<div className="flex flex-wrap gap-3 items-center justify-between">
					...
					<SegmentedControl
						options={[
							{
								value: "api",
								label: t("tabApis") || "OpenAI-compatible APIs",
								icon: "api",
							},
							{
								value: "protocols",
								label: t("tabProtocols") || "Protocols",
								icon: "hub",
							},
						]}
						value={viewTab}
					...
					<div className="mb-6">
						...
						<div className="flex flex-col gap-3">
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(expandedEndpoint === "chat" ? null : "chat")
								}
								copy={copy}
								copied={copied}
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "responses" ? null : "responses"
									)
								}
								copy={copy}
								copied={copied}
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "completions" ? null : "completions"
									)
								}
								copy={copy}
								copied={copied}
					...
					<div className="mb-6">
						...
						<div className="flex flex-col gap-3">
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "embeddings" ? null : "embeddings"
									)
								}
								copy={copy}
								copied={copied}
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "images" ? null : "images"
									)
								}
								copy={copy}
								copied={copied}
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "audioTranscription"
											? null
											: "audioTranscription"
									)
								}
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "audioSpeech" ? null : "audioSpeech"
									)
								}
								copy={copy}
								copied={copied}
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "music" ? null : "music"
									)
								}
								copy={copy}
								copied={copied}
						...
						<div className="mb-6">
							...
							<div className="flex flex-col gap-3">
								<EndpointSection
									...
									onToggle={() =>
										setExpandedEndpoint(
											expandedEndpoint === "search" ? null : "search"
										)
									}
									copy={copy}
									copied={copied}
					...
					<div>
						...
						<div className="flex flex-col gap-3">
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "rerank" ? null : "rerank"
									)
								}
								copy={copy}
								copied={copied}
							...
							<EndpointSection
								...
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "moderation" ? null : "moderation"
									)
								}
								copy={copy}
								copied={copied}
							...
							<EndpointSection
								...
								description={
									t("listModelsDesc") ||
									"List all available models across all connected providers"
								}
								models={[]}
								expanded={expandedEndpoint === "models"}
								onToggle={() =>
									setExpandedEndpoint(
										expandedEndpoint === "models" ? null : "models"
									)
								}
								copy={copy}
								copied={copied}
							...
							<div className="rounded-xl border border-border p-4 bg-bg-subtle">
								<div className="flex items-start justify-between gap-3">
									<div>
										...
										<p className="text-xs text-text-muted mt-1">
											{t("a2aCardDescription") ||
												"Agent2Agent JSON-RPC endpoint"}
										</p>
									</div>
									<span
										className={`text-xs px-2 py-1 rounded-full font-semibold ${
...
function EndpointSection({
	...
	return (
		<div className="border border-border rounded-lg overflow-hidden">
			...
			>
				<div
					className={`flex items-center justify-center size-10 rounded-lg ${iconBg} shrink-0`}
				>
