						...
						<ul className="list-disc pl-6 space-y-2">
							<li>
								<strong className="text-text-main">
									{t("providerConfigurations")}
								</strong>{" "}
								{t("listSeparator")} {t("privacyDataProviderConfigurationsDesc")}
							</li>
							<li>
								<strong className="text-text-main">{t("apiKeys")}</strong>{" "}
								{t("listSeparator")} {t("privacyDataApiKeysDesc")}
							</li>
							<li>
								<strong className="text-text-main">{t("usageLogs")}</strong>{" "}
								{t("listSeparator")} {t("privacyDataUsageLogsDesc")}
							</li>
							<li>
								<strong className="text-text-main">
