...
const { CircuitBreaker, getCircuitBreaker, getAllCircuitBreakerStatuses, STATE } = await import(
...
test("handleComboChat: circuit breaker opens after repeated 502 errors", {
	timeout: 15000,
}, async () => {
	const combo = {
		name: "test-combo",
